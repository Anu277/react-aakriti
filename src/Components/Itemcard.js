...
const ItemCard = React.memo(({ imgSrc, title, description, link }) => {
  return (
    <div className="p-5 m-3 min-w-60 sm:min-w-72 h-auto bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
